# Generated by Django 4.0.4 on 2022-06-07 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('eeg', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_eeg', to='app.eeg', verbose_name='eeg')),
